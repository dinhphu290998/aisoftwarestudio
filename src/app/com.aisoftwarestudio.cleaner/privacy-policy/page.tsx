        ...
        <div className="w-full bg-[#0a0a0a]/80 p-8 md:p-14 rounded-[2rem] border border-white/5 backdrop-blur-2xl shadow-2xl">
          ...
          <div className="space-y-8 leading-relaxed text-slate-400 text-lg">
            ...
            <div className="p-6 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-200">
              <strong>The short version:</strong> Cleaner app does not ask you to create an account, and we do not collect or store your personal information on our servers. The app only accesses your files locally to help you manage storage space.
            </div>

            <p>
              This policy explains how the <strong className="text-white">Cleaner</strong> application ("Cleaner", "the app") handles information. Cleaner is published by <strong className="text-white">AI Software Studio</strong> ("we", "us").
            </p>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-300">
                ...
                <li>Contacts, location, or health data</li>
                <li>The content of your personal files, photos, or messages</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-white/90 mb-4">2. Device Permissions and Data Processing</h2>
              <p>
                To function as intended, Cleaner requires permission to access your device's storage (files and media). This permission is used exclusively to scan for junk files, duplicate images, large files, or cache data so you can free up space. All scanning and deletion processes happen <strong className="text-white">locally on your device</strong>. We do not upload your files, photos, or usage data to any external servers. We cannot see, access, or retrieve the files you choose to delete.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Cleaner may offer optional in-app purchases or subscriptions to unlock premium features. All payments are processed securely by Google Play through your Google account. We never receive or store your payment card details. Google provides us only with anonymous, aggregated sales reporting. Google's handling of your payment information is governed by the <a href="https://policies.google.com/privacy" className="text-blue-400 hover:text-blue-300 transition-colors" target="_blank" rel="noopener noreferrer">Google Privacy Policy</a>.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Cleaner is not directed at children under 13. We do not knowingly collect personal information from children. Because the app collects no personal information from any user, there is nothing for us to delete — but if you have a concern, contact us at the address below.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Questions about this policy or about privacy in Cleaner app: <a href="mailto:aisoftwaresupport@gmail.com" className="text-blue-400 hover:text-blue-300 transition-colors">aisoftwaresupport@gmail.com</a>.
              </p>
            </section>
          </div>
        </div>
