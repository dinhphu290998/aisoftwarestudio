        ...
        <div className="w-full bg-[#0a0a0a]/80 p-8 md:p-14 rounded-[2rem] border border-white/5 backdrop-blur-2xl shadow-2xl">
          ...
          <div className="space-y-8 leading-relaxed text-slate-400 text-lg">
            ...
            <div className="p-6 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-200">
              <strong>The short version:</strong> PDF Scanner does not ask you to create an account, and we do not collect or store your personal information on our servers. Everything you scan or configure stays on your device.
            </div>

            <p>
              This policy explains how the <strong className="text-white">PDF Scanner</strong> application ("PDF Scanner", "the app") handles information. PDF Scanner is published by <strong className="text-white">AI Software Studio</strong> ("we", "us").
            </p>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-300">
                ...
                <li>The content of the documents, images, or files you scan</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-white/90 mb-4">2. Content you provide</h2>
              <p>
                Documents, images, or files you scan using PDF Scanner are processed locally and saved to local storage on your device. We do not upload, copy, index, host, or retain that content, and we cannot see what you have saved. Deleting a file in the app, or deleting the app itself, removes that content from your device. The app requires camera permissions solely for the purpose of scanning documents.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                PDF Scanner is not directed at children under 13. We do not knowingly collect personal information from children. Because the app collects no personal information from any user, there is nothing for us to delete — but if you have a concern, contact us at the address below.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Questions about this policy or about privacy in PDF Scanner: <a href="mailto:aisoftwaresupport@gmail.com" className="text-blue-400 hover:text-blue-300 transition-colors">aisoftwaresupport@gmail.com</a>.
              </p>
            </section>
          </div>
        </div>
