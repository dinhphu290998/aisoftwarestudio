    ...
    <section id="contact" className="w-full max-w-7xl px-6 py-32 z-10 relative border-t border-white/5">
      <div className="flex flex-col md:flex-row gap-16 justify-between">
        ...
        <motion.div 
          ...
          className="flex-1"
        >
          <form className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl shadow-2xl flex flex-col gap-6">
            ...
            <button 
              type="button" 
              className="mt-4 w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 group transition-all"
            >
